			...
			<div className="row">
				<div className="col-lg-6">
					<form>
						...
						<div className="mb-3">
							<input type="checkbox" name="existInstantSalePrice" onChange={this.changeCheckBox} />You want instant sale price.
							{
								this.state.existInstantSalePrice && 
								<div className="input-group mb-3">
									<div className="input-group-prepend">
										<span className="input-group-text">Instant sale price</span>
									</div>
									<input name="instantSalePrice" type="number" className="form-control" onChange={this.changeInputValue} value={this.state.instantSalePrice}/>
								</div>
							}
						</div>
